            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg flex items-start">
                ...
                <div>
                  ...
                  <p>Utilizamos las últimas innovaciones en automatización y gestión de almacenes.</p>
                </div>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg flex items-start">
                ...
                <div>
                  ...
                  <p>Red de distribución internacional para llegar a clientes en todo el mundo.</p>
                </div>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg flex items-start">
                ...
                <div>
                  ...
                  <p>Equipo de atención al cliente disponible en todo momento para resolver sus dudas.</p>
                </div>
              </div>
